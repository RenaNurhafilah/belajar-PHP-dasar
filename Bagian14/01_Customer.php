...
enum Gender: string implements sayHello
{
    ...
    static function fromIndonesia(string $value): Gender
    {
        return match ($value) {
            ...
            default => throw new Exeption("Unsupported Indonesia Value")
        };
    }
...
var_dump(sayHello(new Customer("1", "Daffa", Gender::from("Mr"))));
var_dump(sayHello(new Customer("2", "Waffa", Gender::from("Mrs"))));
var_dump(sayHello(new Customer("2", "Waffa", Gender::tryFrom("Salah"))));
...
var_dump(Gender::fromIndonesia("Nonya"));
